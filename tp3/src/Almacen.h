...
class Almacen{
		...
		public:
				...
				ui enviarCosecha(ui posCosecha);
				bool hayEspacio();
				ui numCosechas();
				ui numDestinos();
				bool hayCosecha(ui posCosecha);
				ui opcionValida(ui max);
				bool destinoValido(ui posCos, ui opcDes);
				void descontarCosecha(ui posCosecha);
				ui verificarDestino(ui posCosecha);
